    ...
    <header>
                    ...
                    <div class="card bg-transparent border-0 mt-4">
                        <div class="card-body">
                            <h1 class="text-white text-center"> 
                                <a href="/controllers/website/home-ctrl.php">Guide Ultime de Super Mario</a>
                            </h1>
                        </div>
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="card bg-transparent border-0 text-center mt-2">
                        <div class="card-body p-0">
                            ...
                            <?php } else { ?>
                                <p class="text-white registration">Bonjour <?= $_SESSION['user']->user ?></p>
                                <a href="/controllers/website/user_profil-ctrl.php?id_user=<?= $_SESSION['user']->id_user ?>">
                                    <img class="w-50 p-1" src="<?= $_SESSION['user']->profil ?>" alt="<?= $_SESSION['user']->profil ?>">
                                </a>
        ...
        <nav class="navbar navbar-expand-md mt-3">
            <div class="container-fluid text-center">
                <button class="navbar-toggler ms-auto border border-white text-white" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item ms-5"><a href="/controllers/website/events-ctrl.php" class="nav-link text-white">Calendrier / Événements</a></li>
                        <li class="nav-item ms-5"><a href="/controllers/website/contact-ctrl.php" class="nav-link text-white">Contact</a></li>
                        <?php if (isset($_SESSION['user']) && ($_SESSION['user']->role == 1)) { ?>
                            <li class="nav-item ms-5"><a href="/controllers/dashboard/dashboard-ctrl.php" class="nav-link text-white">Dashboard</a></li>
                        <?php } ?>
                    </ul>
                </div>
            </div>
